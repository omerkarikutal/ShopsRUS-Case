...
namespace ShopsRUS.Tests
{
    public class InvoiceTest
    {
        ...
        public async Task GetById()
        {
            ...
            var fakeData = CreateData.CreateInvoice().FirstOrDefault(s => s.Id == id);

            var response = new BaseResponse<Invoice>().Success(fakeData);
        ...
        public async Task Add()
        {
            ...
            var fakeData = CreateData.CreateInvoice().FirstOrDefault(s => s.Id == 1);
